...
import { animteWithGsapTimeline } from "../utils/animation"
...
const Model = () => {
    ...
    useEffect(()=>{
        if(size === 'large'){
            animteWithGsapTimeline( tl, small, smallRotation, '#view1', '#view2',{
                transform: 'translateX(-100%)',
                duration: 2
            })
        }if(size === 'small') {
            animteWithGsapTimeline( tl, large, largeRotation, '#view2', '#view1',{
